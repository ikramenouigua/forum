...
export default function Sidebar({children}) {
  ...
  <aside className="sm:h-full sm:w-16 w-full h-12 bg-gray-800 text-gray-200">
    <ul className="text-center flex flex-row sm:flex-col w-full">
      ...
      <li className="sm:border-b border-gray-900 flex-1 sm:w-full" title="Gestion des articles">
        <a id="page-icon" onClick={() => router.push('/GestionArticles')}  className="h-full  w-full hover:bg-gray-700 block p-3">
          <i className="fa fa-gear fill-current text-white"> </i>
        </a>
      </li>
